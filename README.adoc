...
→ → A _shop_finder_ database will be created with _shops_, _blacklisted_shops_, and _users_ collections.
...
The jar will be available in `./build/libs/shop-finder-0.1.0.M2.jar`

You can then launch it with:

```
java -jar build/libs/shop-finder-0.1.0.M2.jar
```
