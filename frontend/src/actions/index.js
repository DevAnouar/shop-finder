import {
  ...
  CLEAR_ERROR, CLEAR_PREFERRED_SHOPS, CLOSE_SIGN_IN_MODAL, CLOSE_WELCOME_MODAL, HOME, NEARBY_SHOPS,
  NEARBY_SHOPS_FETCHED, OPEN_SIGN_IN_MODAL,
...
export const clearPreferredShops = () => ({
  type: CLEAR_PREFERRED_SHOPS
})
